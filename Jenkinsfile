         ...
         stage('Copy to s3') {
          ...
          stage('Create Application') {
            steps {
                ...
                sh 'aws elasticbeanstalk create-application-version --application-name php  --version-label jenkins-pipeline-17  --source-bundle S3Bucket=jenkins-backup-files-sa,S3Key=myzip.zip'
            }
        }
